...
import com.revature.quizzard.util.helpers.EntitySearchHelper;
...
public class UserService {
    ...
    @Autowired
    public UserService(UserRepository userDao, EntitySearchHelper entitySearchHelper) {
    ...
    public Set<AppUser> searchUsers(Map<String, String> requestParamMap) {
        ...
        Set<AppUser> matchingUsers = entitySearchHelper.searchForEntity(requestParamMap, AppUser.class);
